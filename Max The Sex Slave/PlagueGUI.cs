                    ...
                    void MakeButton()
                    {
                        switch (Button.Key.Item3)
                        {
                            ...
                            case ButtonType.Slider:
                                ...
                                float NewFloatValue = GUI.HorizontalSlider(new Rect(0, (25 * ButtonPosMultiplier) + 7, PositionAndScale.width, PositionAndScale.height), DropDownState[DropData].FloatCache[ControlID], 0, 5);
